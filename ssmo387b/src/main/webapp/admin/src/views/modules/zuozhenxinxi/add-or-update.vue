<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.yishengzhaopian" label="医生照片" prop="yishengzhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yishengzhaopian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医生职称" prop="yishengzhicheng">
          <el-input v-model="ruleForm.yishengzhicheng" 
              placeholder="医生职称" clearable  :readonly="ro.yishengzhicheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医生职称" prop="yishengzhicheng">
              <el-input v-model="ruleForm.yishengzhicheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="挂号数量" prop="guahaoshuliang">
          <el-input v-model="ruleForm.guahaoshuliang" 
              placeholder="挂号数量" clearable  :readonly="ro.guahaoshuliang"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="医生履历" prop="yishenglvli">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="医生履历"
                  v-model="ruleForm.yishenglvli" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yishenglvli" label="医生履历" prop="yishenglvli">
                    <span>{{ruleForm.yishenglvli}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.yishengzhaopian!=''&&json.yishengzhaopian){
                this.ruleForm.yishengzhaopian = json.yishengzhaopian
	    		this.ro.yishengzhaopian = true;
		}
		if(json.yishengzhicheng!=''&&json.yishengzhicheng){
                this.ruleForm.yishengzhicheng = json.yishengzhicheng
	    		this.ro.yishengzhicheng = true;
		}
		if(this.$storage.get("role")!="管理员") {
			this.ro.yishengzhicheng = true;
