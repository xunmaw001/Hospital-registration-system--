...
public class GuahaojiluController {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,GuahaojiluEntity guahaojilu, 
		HttpServletRequest request){
    ...
    public R info(@PathVariable("id") Long id){
		...
		guahaojilu.setClicknum(guahaojilu.getClicknum()+1);
		guahaojiluService.updateById(guahaojilu);
